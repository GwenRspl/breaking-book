...
public class BookRepositoryImpl implements BookRepository {
    ...
    private final String INSERT = "INSERT INTO book(book_title, book_authors, book_isbn, book_image, book_language, " +
            "book_publisher, book_date_published, book_pages, book_synopsis, book_reader, book_friend, book_owned, book_rating, book_comment) " +
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private final String UPDATE = "UPDATE book SET book_title = ?, book_authors = ?, book_isbn = ?, book_image = ?, " +
            ...
            "book_reader = ?, book_friend = ?, book_owned = ?, book_rating = ?, book_comment = ? WHERE book_id = ?";
